...
function initAjaxForms() {
    ...
    $('form[data-ajax]').on('submit', function (e) {
        ...
        form.prepend('<div class="ui active inverted dimmer"><div class="ui text loader">Chargement</div></div>')
        ...
        function displaySuccess(form, message) {
            form.find('.ajax-message').html('<div class="ui positive message"><div class="header">Succès</div><p>' + message + '</p></div><div class="ui divider"></div>');
            removeDimmer(form)
        }

        function displayError(form, message) {
            form.find('.ajax-message').html('<div class="ui negative message"><div class="header">Erreur</div><p>' + message + '</p></div><div class="ui divider"></div>');
            removeDimmer(form)
